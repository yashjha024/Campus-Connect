...
export default function Signup() {
  ...
  const validateRollNumber = (rollNumber) => {
    const rollNumberPattern = /^BTECH\/\d{5}\/\d{2}$/i;
  ...
  const handleSignup = async () => {
    if (!validateRollNumber(rollnumber)) {
      ...
      toast.error("Invalid roll number format. It should be BTECH/XXXXX/YY");
      return;
    }
    setSpin(true);
    try {
          ...
          {isEmailVerified ? (
            <>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Enter Your Roll Number (e.g., BTECH/XXXXX/YY)"
