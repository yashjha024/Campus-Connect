                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {displayedRecords.map((record) => (
                            <tr key={record.rollNumber} className={selectedRows.includes(record.rollNumber) ? 'bg-gray-100' : ''}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">{record.gpaBySemester[1] || '-'}</td>
                                <td className="px-6 py-4 whitespace-nowrap">{record.gpaBySemester[2] || '-'}</td>
                                <td className="px-6 py-4 whitespace-nowrap">{record.gpaBySemester[3] || '-'}</td>
                                <td className="px-6 py-4 whitespace-nowrap">{record.gpaBySemester[4] || '-'}</td>
                                <td className="px-6 py-4 whitespace-nowrap">{record.gpaBySemester[5] || '-'}</td>
                                <td className="px-6 py-4 whitespace-nowrap">{record.gpaBySemester[6] || '-'}</td>
                                <td className="px-6 py-4 whitespace-nowrap">{record.gpaBySemester[7] || '-'}</td>
                                <td className="px-6 py-4 whitespace-nowrap">{record.gpaBySemester[8] || '-'}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
