      ...
      html: `
        ...
        <body>
          <div class="email-container">
            ...
            <div class="content">
              <p>Hello,</p>
              <p>Thank you for choosing Campus Connect. To complete your verification process, please use the following One-Time Password (OTP):</p>
            ...
            <div class="footer">
              &copy; Campus Connect 2024. All rights reserved.
            </div>
          </div>
        </body>
        </html>
    ...
    html: `
        ...
        <body>
          <div class="email-container">
            ...
            <div class="content">
              <p>Hello,</p>
              <p>Thank you for choosing Campus Connect. To reset your password, please use the following One-Time Password (OTP):</p>
              <p class="otp">${tOtp.otp}</p>
              <p>If you did not request this OTP, please ignore this email or contact our support team.</p>
              <p>Best regards,</p>
              <p>TEAM CAMPUS CONNECT</p>
